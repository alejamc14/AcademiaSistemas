...
async function Ejecutar(Metodo, Funcion) {
    ...
    EjecutarComandoServicioAuth(Metodo, URL, sancion);
...
async function Consultar() {
    ...
    const sancion = await ConsultarServicioAuth(URL);
...
async function LlenarTabla() {
    LlenarTablaXServiciosAuth("https://localhost:44387/api/Sancions/LlenarTabla", "#tblSanciones");
}

async function ObtenerEstudiantes() {
    LlenarComboXServiciosAuth("https://localhost:44387/api/Sancions/ObtenerEstudiantes", "txtIdEstudiante");
}