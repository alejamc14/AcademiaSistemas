...
async function Ejecutar(Metodo, Funcion) {
    ...
    EjecutarComandoServicioAuth(Metodo, URL, calificacion);
...
async function Consultar() {
    ...
    const calificacion = await ConsultarServicioAuth(URL);
...
async function LlenarTabla() {
    LlenarTablaXServiciosAuth("https://localhost:44387/api/Calificacions/LlenarTabla", "#tblCalificaciones");
}

async function ObtenerEstudiantes() {
    LlenarComboXServiciosAuth("https://localhost:44387/api/Calificacions/ObtenerEstudiantes", "txtIdEstudiante");
}

async function ObtenerCurso() {
    LlenarComboXServiciosAuth("https://localhost:44387/api/Calificacions/ObtenerCurso", "txtIdCurso");
}